...
///\todo fix this mess and make a proper map that is manipulated by this editor
...
public:
    ...
    void exportColorMap(Misc::ColorMap& map) const;
    void importColorMap(const Misc::ColorMap& map);
    };
